    ...
    return (
        <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6'>
            <div className='h-20 relative'>
                <Image
                    src={user.cover || "https://images.pexels.com/photos/27054232/pexels-photo-27054232.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"}
                    alt=''
                    fill
            ...
            <div className='h-20 flex flex-col gap-2 items-center'>
                ...
                <div className='flex items-center gap-4'>
                    <div className='flex'>
                        <Image
                            src="https://images.pexels.com/photos/27591717/pexels-photo-27591717.jpeg?auto=compress&cs=tinysrgb&w=400&lazy=load"
                            alt=''
                            width={12}
                            height={12}
